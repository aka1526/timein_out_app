...
<body>
    <div class="main-container">
        <div class="form-container">
            ...
            <form action="{{ route('time_attendances.storeAfternoonCheckIn') }}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn btn-danger btn-submit">
                    <i class="bi bi-check-circle me-2"></i> บันทึกเวลาเข้าบ่าย
                </button>
            </form>
